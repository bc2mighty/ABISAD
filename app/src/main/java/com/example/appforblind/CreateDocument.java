...
public class CreateDocument extends AppCompatActivity implements TextToSpeech.OnInitListener{
...
//            speechRecognizer.startListening(speechRecognizerIntent);
    ...
    public void speechActions(){
        speechRecognizer = SpeechRecognizer.createSpeechRecognizer(CreateDocument.this);
            ...
            public void onResults(Bundle results) {
                ...
                if(matchesFound != null){
                    ...
                    if(keeper.contains("home")){
                        Intent intent = new Intent(CreateDocument.this, MainActivity.class);
                        startActivity(intent);
                    } else if(keeper.contains("back")){
                        Intent intent = new Intent(CreateDocument.this, TextEditorActivity.class);
                        startActivity(intent);
                    } else if(keeper.contains("contact")){
                        Intent intent = new Intent(CreateDocument.this, Contact.class);
                        startActivity(intent);
                    ...
                    } else if(keeper.contains("read") || keeper.contains("content")){
                        CreateDocument.this.setData("The content currently is: . . . . " +  docContent.getText().toString());
                        performSpeech();
                    ...
                    Toast.makeText(CreateDocument.this, "Results - " + keeper, Toast.LENGTH_LONG).show();
                }
            }
    ...
    public void createDocument(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("title",CreateDocument.this.docTitle.getText().toString());
                params.put("content", CreateDocument.this.docContent.getText().toString());
                return params;
            }
        };
